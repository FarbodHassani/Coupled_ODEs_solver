...
\begin{equ}\label{eq:main}
  u_{tt}-\beta u_{xx}=\alpha (u_x)^2~, \quad \HZ{\beta \ge 0}, \quad \alpha\ne0 ~,
\end{equ}
...
\begin{equa}\label{eq:dotb}
  ...
  \end{equa}
which means $b$ is increasing \HZ{and the quantity below the square
  root 
  is always positive}. Using standard techniques, we get 
\begin{equa}
