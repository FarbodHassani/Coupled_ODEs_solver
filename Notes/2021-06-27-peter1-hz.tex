...
\end{equation}
\HZ{ Here, I am afraid this formula is valid only when $b(0)\ge
  b_*$.... What do you think ? Accordingly, the statement of item (i)
  in the proposition has to be changed.}\\
