program  cosmology
  !!gfortran -O6 -ffree-line-length-0 one_orbit_no_taustar.f90 dopri5_no_rpar.f90 dopri5copy_no_rpar.f90 -o one_orbit_no_taustar
  !! ifort -xHost -O3 -w -qopt-report -prof-use -ipo one_orbit_no_taustar.f90 dopri5_no_rpar.f90 dopri5copy_no_rpar.f90  -o one_orbit_no_taustar
