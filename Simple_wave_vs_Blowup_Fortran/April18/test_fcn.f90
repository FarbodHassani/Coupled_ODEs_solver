program test_fcn
  !! gfortran -O6 -ffree-line-length-0 test_fcn.f90 fcn.f90 dopri5_no_rpar.f90 fftpack5.o
  !! ifort -xHost -O3 -w -qopt-report -prof-use -ipo test_fcn.f90 fcn.f90 dopri5_no_rpar.f90 fftpack5.f90  
