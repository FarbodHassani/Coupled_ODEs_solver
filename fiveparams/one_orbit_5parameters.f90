program  cosmology
  !!gfortran -O6 -ffree-line-length-0 one_orbit_5parameters.f90 dopri5_no_rpar.f90 dopri5copy_no_rpar.f90 -o one_orbit_5parameters
  !! ifort -xHost -O3 -w -qopt-report -prof-use -ipo one_orbit_5parameters.f90 dopri5_no_rpar.f90 dopri5copy_no_rpar.f90  -o one_orbit_5parameters
  ...
  real*8 exp
  real*8 pi2_i,pi2p_i,cs2_i,w_i,psi2_i
  ...
  numarg = iargc ( )
  if(numarg.ne.5)then
     print *,"need 5 args: pi2,piprime2 cs2,w,psi2"
     print *,"run; one_orbit_5parameters  pi2 piprime2 cs2 w psi2 | plot5.pl |xmgrace -"
     stop
  endif
  pi2_i =myarg(1)
  pi2p_i=myarg(2)
  ...
  write(6,*)'w=',w_i
  write(6,*)'psi2=',psi2_i
  write(6,*)'zfinal=',zfinal


  !  write(6,*)'Odarke=',Odarke
  !  write(0,*)'1-cs2=',1D0-cs2_i

!  kvalue=[0d0,0d0,psi2_i,0d0,0d0]
!!    kvalue=[0.142857d0,0d0,-0.2d0,0d0,0.33333333d0]
...
!          write(0,*)tauini,tauend
     do paramc=0,nc   !loop over c_s^2
        ...
        do i=1,n
           y(i)=0
        enddo
        ! here we initialize the 3 parameters which evolve in time
        ! note that w and cs2 are not variables in y
...
!goto 12345
        write(0,'(4e15.7,i4)')cs2,psi2_i,x,xend,idid

        if(idid==-15)then
           write(0,*)'singularity detected at taustar',x
        endif
        if(idid==-3)then
           write(0,*)'stepsize too small',x,xend
        endif
        if(idid==-17)then
